...
// Header styles
if ( ! function_exists( 'neatmag_header_style' ) ) :
function neatmag_header_style() {
    ...
    <?php else : ?>
        .neatmag-site-title, .neatmag-site-title a, .neatmag-site-description {color: #<?php echo esc_attr( $header_text_color ); ?>;}
    <?php endif; ?>
    </style>
    <?php
}
