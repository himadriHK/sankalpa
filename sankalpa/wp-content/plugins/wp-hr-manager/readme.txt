...
Contributors: wphrmanager, blackandwhitedigital, freemius
...
* __WP-HR Add Fields__(Add extra fields to collect and display information in the employee profile)
 ...
 * Fix - Fixed Date of Hire Incorrectly showing Today's Date
 * Fix - User nicename adding 2-2-2-2 
 * Fix - Updated to fix security issue
...
Fix - Fixed Date of Hire Incorrectly showing Today's Date
Fix - User nicename adding 2-2-2-2 
Fix - Update to fix security issue
