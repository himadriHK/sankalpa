...
class Company_Locations extends Model {
    ...
    protected $fillable = [ 'name', 'address_1', 'address_2', 'city', 'state', 'zip', 'country', 'office_start_time', 'office_end_time', 'office_working_hours', 'office_timezone', 'office_financial_year_start' ];
