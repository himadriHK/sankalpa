...
class Ajax {
    ...
    public function location_create() {
        ...
        $office_start_time      = isset( $_POST['office_start_time'] ) ? date( 'H:i:s', strtotime( $_POST['office_start_time'] ) ) : '';
        $office_end_time      = isset( $_POST['office_end_time'] ) ? date( 'H:i:s', strtotime( $_POST['office_end_time'] ) ) : '';
		$office_working_hours = isset( $_POST['office_working_hours'] ) ? $_POST['office_working_hours'] : 9; 
		$office_timezone	  = isset( $_POST['office_timezone'] ) ? sanitize_text_field( $_POST['office_timezone'] ) : '';	
		$office_financial_year_start = isset( $_POST['office_financial_year_start'] ) ? $_POST['office_financial_year_start'] : '';
        $args = [
            'id'         => $location_id,
            'name'       => $location_name,
            'address_1'  => $address_1,
