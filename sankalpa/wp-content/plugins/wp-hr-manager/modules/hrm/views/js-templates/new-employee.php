    ...
    <?php if( current_user_can( 'wphr_edit_employee' ) ): ?>
        <fieldset>
            ...
            <# } #>
				...
				<li class="apply_leave_panel" data-selected="{{ data.work.leave_year }}">
					<?php wphr_html_form_input( array(
                        'label'    => __( 'Leave Year', 'wphr' ),
                        'name'     => 'work[leave_year]',
                        'type'     => 'select', 
                        'options'  => wphr_months_dropdown(),
                        'value'    => '{{ data.work.leave_year }}',
                        'required' => true,
                    ) ); ?>
				</li>

                <li class="apply_leave_year_panel" data-selected="{{ data.work.apply_leave_year }}">
                    <?php wphr_html_form_input( array(
                        'label'       => __( 'Apply This Leave Year?', 'wphr' ),
                        'name'        => 'work[apply_leave_year]',
                        'type'    	  => 'checkbox',
						'value'		  => 1,
                    ) ); ?>
                </li>
